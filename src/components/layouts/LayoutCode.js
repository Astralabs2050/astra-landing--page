...
const LayoutCode = () => {
  return (
    <div className="bg-bg1 bg-black  bg-fixed bg-cover z-[-1] relative flex lg:flex-row flex-col lg:justify-evenly lg:gap-0 gap-[30px] items-center py-[100px] text-white">
      <div className="">
        <p>
          <img src={enquires} alt="" className="lg:hidden flex pb-[30px]" />
        </p>
        <form className="w-[334.06px]  bg-[#121212] overflow-y-hidden border border-[#D9D9D933] px-[25px] py-[35px] h-[438.55px] rounded-[5px]">
          <p className="text-[23.13px] font-[400] mb-[10px]">Get in Touch</p>
          ...
          <input
            ...
            type="text"
            className="border px-[10px] text-[12.03px] outline-none mb-[15px] w-full h-[37.01px] rounded-[5px] bg-[#D9D9D91A]"
          />
          <br />
          <textarea
      ...
      <div className="px-[30px] lg:px-0">
        <img
          src={Glitter}
          alt=""
          className="absolute right-[730px] bottom-[780px] lg:flex hidden z-10"
        />{" "}
