...
const Layout3 = () => {
  ...
  return (
    <>
      <table className="table-auto z-[10] border-collapse border-[0.5px] border-[#A1A1A1] overflow-hidden w-full absolute top-[1570px] lg:top-[2380px]">
        <tr>
      ...
      <div className="z-[9999] flex flex-col-reverse lg:flex-row lg:mx-auto lg:items-center gap-[30px] lg:gap-[130px] bg-[url('/Users/ijeoma/Documents/astra-landing-page/src/assets/BACKGROUND-BLACK3.png')] bg-cover lg:pt-[200px] pt-[120px] lg:pb-[250px] text-white w-[100%]">
