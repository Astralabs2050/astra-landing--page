...
//   }, []);
//   return (
//     <div className="bg-bg1 bg-black bg-cover flex flex-col items-center justify-center">
...
//       </p>
//       <div
//         className={`flex lg:flex-row flex-col lg:gap-[14px] gap-[18px] lg:px-[50px] overflow-y-hidden text-white pt-[50px] lg:pt-[100px] justify-between w-[100%] items-center   px-[20px] overflow-auto pb-[50px] lg:pb-[300px]`}
//       >
//         <div
//           data-aos="fade-left"
...
//         <div
//           data-aos="fade-right"
//           className="justify-center items-center w-[100%] md:px-[30px] lg:px-0 lg:w-[70%]"
//         >
