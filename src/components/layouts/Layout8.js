...
const Layout8 = () => {
  ...
  return (
    <>
      <div className="bg-[url('/Users/ijeoma/Documents/astra-landing-page/src/assets/BACKGROUND-BLACK7.png')] bg-cover  bg-black opacity-95 text-white flex lg:flex-row flex-col lg:justify-evenly gap-[50px] lg:items-center mt-[] pl-[20px] lg:h-[267px] py-[40px]">
